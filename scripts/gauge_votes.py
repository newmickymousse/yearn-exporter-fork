...
from yearn.db.models import GaugeVotes, engine, select, Session, engine, select
...
dola_gauge_creation_block = 10647875#13608864
...
def votes_by_gauge():
    ...
    while True == True:
        ...
        logs = web3.eth.get_logs(
                {'address': gauge_controller_addr, 'topics': topics, 'fromBlock': last_block_checked, 'toBlock': current_block }
        )
        ...
        for event in events:
            ...
            with Session(engine) as session:
                ...
                #     insert_success = True
                # except:
                #     print(f"skipped duplicate record at tx hash: {v.txn_hash}")
                #     pass
